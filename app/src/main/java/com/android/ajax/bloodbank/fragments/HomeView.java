package com.android.ajax.bloodbank.fragments;
...
import com.android.ajax.bloodbank.adapters.BloodRequestAdapter;
import com.android.ajax.bloodbank.viewmodels.CustomUserData;
...
public class HomeView extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Green Hospital");
    ...
    private void AddPosts()
    {
        ...
        allposts.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(getActivity(), "No records!",
